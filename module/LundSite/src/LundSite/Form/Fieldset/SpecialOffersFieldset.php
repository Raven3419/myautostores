 ...
 * @link       https://github.com/rocketred/www-lunddigitalplatform for the canonical source repository
 */
class SpecialOffersFieldset extends Fieldset
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('special-offers-fieldset');

        $this->setHydrator(new DoctrineHydrator($objectManager, 'LundSite\Entity\SpecialOffers'));

        $this->add(array(
            'type' => 'Zend\Form\Element\Hidden',
            'name' => 'specialOffersId',
        ));
