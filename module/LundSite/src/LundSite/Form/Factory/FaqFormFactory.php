 ...
 * @link       https://github.com/rocketred/www-lunddigitalplatform for the canonical source repository
 */
class FaqFormFactory implements FactoryInterface
{
    /**
    ...
    public function createService(ServiceLocatorInterface $serviceLocator)
    {
        ...
        $fieldsetInputFilter = $parentLocator->get('InputFilterManager')->get('LundSite\InputFilter\FaqFilter');
        $formFilter->add($fieldsetInputFilter, 'faq-fieldset');
