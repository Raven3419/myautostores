 ...
 */
class Layout extends \RocketCms\Entity\Layout implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'createdAt', 'createdBy', 'modifiedAt', 'modifiedBy', 'deleted', 'disabled', 'name', 'description', 'directory', 'active', 'layoutId', 'site');
        }
    ...
    public function getLayoutId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getLayoutId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLayoutId', array());
