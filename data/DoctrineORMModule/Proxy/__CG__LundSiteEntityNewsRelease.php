...
class NewsRelease extends \LundSite\Entity\NewsRelease implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'createdAt', 'createdBy', 'modifiedAt', 'modifiedBy', 'deleted', 'disabled', 'newsType', 'title', 'url', 'image', 'teaser', 'displayDate', 'html', 'newsReleaseId', 'site', 'brand');
        }
