 ...
 */
class FaqHeaders extends \LundSite\Entity\FaqHeaders implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'createdAt', 'createdBy', 'modifiedAt', 'modifiedBy', 'deleted', 'disabled', 'header', 'position', 'faqHeadersId');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FaqHeaders $proxy) {
    ...
    public function getFaqHeadersId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getFaqHeadersId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFaqHeadersId', array());

        return parent::getFaqHeadersId();
    }
