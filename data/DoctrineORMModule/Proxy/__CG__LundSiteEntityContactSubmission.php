 ...
 */
class ContactSubmission extends \LundSite\Entity\ContactSubmission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'createdAt', 'createdBy', 'modifiedAt', 'modifiedBy', 'deleted', 'disabled', 'firstName', 'lastName', 'emailAddress', 'streetAddress', 'extStreetAddress', 'locality', 'postCode', 'phoneNumber', 'comments', 'contactSubmissionId', 'site', 'region', 'country');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContactSubmission $proxy) {
    ...
    public function getContactSubmissionId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getContactSubmissionId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getContactSubmissionId', array());

        return parent::getContactSubmissionId();
    }
