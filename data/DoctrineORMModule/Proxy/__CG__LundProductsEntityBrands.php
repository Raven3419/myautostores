...
class Brands extends \LundProducts\Entity\Brands implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'createdAt', 'createdBy', 'modifiedAt', 'modifiedBy', 'deleted', 'disabled', 'name', 'shortCode', 'label', 'aaiaid', 'html', 'metaTitle', 'metaKeywords', 'metaDescr', 'brandId', 'parentBrand', 'brandProductCategory', 'asset');
        }
