 ...
 */
class OrderAddress extends \RocketEcom\Entity\OrderAddress implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'createdAt', 'createdBy', 'modifiedAt', 'modifiedBy', 'deleted', 'disabled', 'firstName', 'lastName', 'streetAddress', 'extStreetAddress', 'locality', 'postCode', 'phoneNumber', 'addressType', 'orderAddressId', 'order', 'region', 'country');
        }
    ...
    public function getOrderAddressId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getOrderAddressId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOrderAddressId', array());

        return parent::getOrderAddressId();
    }
