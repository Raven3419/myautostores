 ...
 */
class ShippingMethod extends \RocketEcom\Entity\ShippingMethod implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'createdAt', 'createdBy', 'modifiedAt', 'modifiedBy', 'deleted', 'disabled', 'shortCode', 'label', 'shippingMethodId');
        }
    ...
    public function getShippingMethodId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getShippingMethodId();
        }
