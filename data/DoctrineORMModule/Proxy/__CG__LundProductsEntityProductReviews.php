 ...
 */
class ProductReviews extends \LundProducts\Entity\ProductReviews implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'createdAt', 'createdBy', 'modifiedAt', 'modifiedBy', 'deleted', 'disabled', 'review', 'rating', 'productReviewId', 'user', 'productLines');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductReviews $proxy) {
    ...
    public function getProductReviewId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getProductReviewId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProductReviewId', array());

        return parent::getProductReviewId();
    }
