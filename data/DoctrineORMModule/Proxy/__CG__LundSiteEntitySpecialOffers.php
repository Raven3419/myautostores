 ...
 */
class SpecialOffers extends \LundSite\Entity\SpecialOffers implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'createdAt', 'createdBy', 'modifiedAt', 'modifiedBy', 'deleted', 'disabled', 'title', 'html', 'specialOffersId', 'asset', 'site', 'brand');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SpecialOffers $proxy) {
    ...
    public function getSpecialOffersId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getSpecialOffersId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSpecialOffersId', array());

        return parent::getSpecialOffersId();
    }
