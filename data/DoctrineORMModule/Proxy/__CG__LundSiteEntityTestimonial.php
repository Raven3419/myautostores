 ...
 */
class Testimonial extends \LundSite\Entity\Testimonial implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'createdAt', 'createdBy', 'modifiedAt', 'modifiedBy', 'deleted', 'disabled', 'position', 'content', 'testimonialId', 'site');
        }
    ...
    public function getTestimonialId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getTestimonialId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTestimonialId', array());

        return parent::getTestimonialId();
    }
