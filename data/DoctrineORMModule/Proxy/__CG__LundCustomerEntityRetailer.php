...
class Retailer extends \LundCustomer\Entity\Retailer implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'createdAt', 'createdBy', 'modifiedAt', 'modifiedBy', 'deleted', 'disabled', 'retailerType', 'companyName', 'streetAddress', 'extStreetAddress', 'locality', 'postCode', 'phoneNumber', 'latitude', 'longitude', 'website', 'discount', 'discountCopy', 'discountUrl', 'retailerId', 'region', 'country', 'logoAsset', 'discountAsset', 'poiAsset', 'brand', 'shipsCountry', 'customerOrDealer', 'customerId');
        }
