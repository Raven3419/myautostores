...
class OrderItem extends \RocketEcom\Entity\OrderItem implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'createdAt', 'createdBy', 'modifiedAt', 'modifiedBy', 'deleted', 'disabled', 'productId', 'quantity', 'description', 'price', 'weight', 'length', 'height', 'width', 'upcCode', 'orderItemId', 'order', 'cartItem');
        }
     ...
     * {@inheritDoc}
     */
    public function setCartItem(\RocketEcom\Entity\CartItem $cartItem = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCartItem', array($cartItem));
    ...
    public function getCartItem()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCartItem', array());
